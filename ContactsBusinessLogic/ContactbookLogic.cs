...
namespace ContactbookLogicLibrary
{
    public class ContactBookLogic
    {
        ...
        public void EditContact(int inputindex, string c, SQLConnection sql)
        {
            ...
            {
                //GET NEW VALUE
                while (!CorrectInput) //Todo: in contactbookinputcontrol verlagern
                {
            ...
            {
                //GET NEW VALUE
                while (!InputIsNumber)//Todo: in contactbookinputcontrol verlagern
                {
        ...
        public void EditLocation(int inputindex, string c, SQLConnection sql)
        {
            ...
            if (locHasConCount == 0)
            {
                if (c == "1")
                {
                    Console.WriteLine($"Please enter the new value for the address."); //TODOH: raus aus logic
                ...
                {
                    Console.WriteLine($"Please enter the new value for the cityname.");//TODOH: raus aus logic
                ...
                Console.WriteLine("WARNING: You can't edit a location that is linked to an existing contact");//TODOH: raus aus logic
        }
